...
WELCOME_VID = environ.get("WELCOME_VID", "https://envs.sh/JLf.mp4")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "maamdao")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/bookrequest_group')
