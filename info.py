...
BOT_TOKEN = environ.get('BOT_TOKEN', "7457680560:AAGUzB2UT8YLjRxVs95IfZny-XogLIgAB7Q")
...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002310300801').split(','))))
