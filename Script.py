...
<b><blockquote>ɪ ᴀᴍ ᴀ ᴍᴏᴠɪᴇ ʙᴏᴛ ᴛʜᴀᴛ ᴘʀᴏᴠɪᴅᴇꜱ ᴍᴏᴠɪᴇꜱ ᴀɴᴅ ᴡᴇʙꜱᴇʀɪᴇꜱ ɪɴꜱɪᴅᴇ ᴀ ɢʀᴏᴜᴘ ᴏʀ ꜱᴏᴍᴇᴛɪᴍᴇꜱ ᴏɴ ᴘᴇʀꜱᴏɴᴀʟ ɪɴᴛᴇʀᴀᴄᴛɪᴏɴꜱ.</blockquote>\n\n<blockquote>ᴛᴏ ᴇɴᴊᴏʏ ᴍʏ ꜰᴜʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟ, ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ(ꜱ) ᴀɴᴅ <u>ᴍᴀᴋᴇ ᴍᴇ ᴀɴ ᴀᴅᴍɪɴ ʙʏ 'ᴇɴᴀʙʟɪɴɢ ᴀʟʟ ᴛʜᴇ ᴀᴅᴍɪɴ ᴘʀɪᴠɪʟᴇɢᴇꜱ'</u></b>.</blockquote>
...
©️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ: @theultimatetheatre"""
    ...
    CHANNELS = """
<b>ᴊᴏɪɴ ᴛʜᴇꜱᴇ ᴄʜᴀɴɴᴇʟꜱ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴏɴ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ, ꜱᴇʀɪᴇꜱ ᴀɴᴅ ᴛʜᴇ ʙᴏᴛ ɪᴛꜱᴇʟꜰ!</b>"""
